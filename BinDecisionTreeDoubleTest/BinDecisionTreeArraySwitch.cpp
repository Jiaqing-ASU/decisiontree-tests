...
struct Treenode {
    ...
    int comSymbol; //symbol to compare
    /* 1 for =; 2 for <; 3 for >; 4 for <=; 5 for >=, 6 for !=, 7 for leaf*/
};
...
int main(int argc, const char *argv[])
{
    ...
    treenodes[0] = {0,1.0,false,1,2,1};
    treenodes[1] = {1,4.0,false,3,4,1};
    treenodes[2] = {0,2.0,false,5,6,1};
    treenodes[3] = {-1,2.0,true,-1,-1,7};
    treenodes[4] = {1,5.0,false,7,8,1};
    treenodes[5] = {-1,1.0,true,-1,-1,7};
    treenodes[6] = {0,3.0,false,9,10,1};
    treenodes[7] = {-1,1.0,true,-1,-1,7};
    treenodes[8] = {-1,-1.0,true,-1,-1,7};
    treenodes[9] = {2,6.0,false,11,12,1};
    treenodes[10] = {-1,-1.0,true,-1,-1,7};
    treenodes[11] = {-1,2.0,true,-1,-1,7};
    treenodes[12] = {2,7.0,false,13,14,1};
    treenodes[13] = {-1,1.0,true,-1,-1,7};
    treenodes[14] = {-1,-1.0,true,-1,-1,7};
