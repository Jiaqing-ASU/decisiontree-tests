CREATE OR REPLACE FUNCTION call_single_specialized_needed() RETURNS table (result double precision) 
AS
$BODY$
...
begin
	...
	LOOP
		...
		EXECUTE format('SELECT specialized_needed($1);') using single_array into single_result;
