CREATE OR REPLACE FUNCTION call_single_paths_whole() RETURNS table (result double precision) 
AS
$BODY$
...
begin
	...
	LOOP
		...
		EXECUTE format('SELECT paths($1);') using single_array into single_result;
